...
class TestUserDelete(BaseCase):
    ...
    def test_delete_user_unauthorized(self):
        ...
        response_login = requests.post(self.LOGIN_URL, data=login_data)
    ...
    def test_delete_user_success(self):
        ...
        response_register = requests.post(self.URL, data=register_data)
    ...
    def test_delete_user_by_another_user(self):
        ...
        response_register1 = requests.post(self.URL, data=register_data1)
        ...
        response_login1 = requests.post(self.LOGIN_URL, data=login_data1)
        ...
        response_register2 = requests.post(self.URL, data=register_data2)
